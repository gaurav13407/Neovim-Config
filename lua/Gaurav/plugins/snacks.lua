return { 
    -- HACK: docs @ https://github.com/folke/snacks.nvim/blob/main/docs
    {
        ...
        keys = {
            ...
            { "<leader>r", function() require("snacks").rename.rename_file() end, desc = "Fast Rename Current File" },
            
            --{ "<leader>f", function() require("snacks").explorer() end, desc = "Open Snacks Explorer" },
